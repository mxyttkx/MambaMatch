...
net_arg.add_argument(
    "--clusters", type=int, default=150, help=""
    "cluster number in OANet. Default: 200")
net_arg.add_argument(
...
data_arg.add_argument(
    "--data_tr", type=str, default=r'../yfcc-sift-2000-train.hdf5', help=""
    "name of the dataset for train")
data_arg.add_argument(
    "--data_va", type=str, default=r'../yfcc-sift-2000-val.hdf5', help=""
    "name of the dataset for valid")
data_arg.add_argument(
    "--data_te", type=str, default=r'../yfcc-sift-2000-test.hdf5', help=""
...
train_arg.add_argument(
    "--log_base", type=str, default='../model-yfcc-sift/', help=""
